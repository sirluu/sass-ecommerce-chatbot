package com.luu.ubas.service.security;
...
//		Map<String, Object> request = (Map<String, Object>) map.get("oauth2Request");
		...
		Set<String> authorities = new LinkedHashSet<>(request.containsKey("authorities") ?
				(Collection<String>) request.get("authorities") : Collections.<String>emptySet());

		return new OAuth2Request(null, clientId, null, true, new HashSet<>(authorities),
				null, null, null, null);
	}
