...
import com.luu.ubas.payload.request.LoginRequest;
import com.luu.ubas.payload.request.SignupRequest;
import com.luu.ubas.payload.response.JwtResponse;
...
import com.luu.ubas.security.jwt.JwtUtils;
...
public class AuthController {
  ...
  public ResponseEntity<?> authenticate(@Valid @RequestBody LoginRequest loginRequest,
    ...
    try {
      ...
      System.out
          .println("::::::::::::::::::: after authenticationmanager : " + loginRequest.getEmail());
