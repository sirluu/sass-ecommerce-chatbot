...
public class UserDetailsImpl implements UserDetails {
  ...
  public static UserDetailsImpl build(Doctor user) {
    ...
    UserDetailsImpl userI = new UserDetailsImpl(user.getId(), user.getUsername(), user.getEmail(),
        user.getPassword(), DOCTOR, authorities);
  ...
  public static UserDetailsImpl build(Patient user) {
    ...
    return new UserDetailsImpl(user.getId(), user.getUsername(), user.getEmail(),
        user.getPassword(), PATIENT, authorities);
  }
  ...
  public static UserDetailsImpl build(Admin user) {
    ...
    return new UserDetailsImpl(user.getId(), user.getUsername(), user.getEmail(),
        user.getPassword(), ADMIN, authorities);
  }
