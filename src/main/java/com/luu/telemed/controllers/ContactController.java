...
import com.luu.telemed.services.ContactService;
...
public class ContactController {
  ...
  public ResponseEntity<Contact> sendContact(
      @ApiParam(value = "Contact", required = true) @RequestBody Contact contact)
      throws ResourceAlreadyExistsException {
    Contact result = contactService.save(contact).orElseThrow(
        () -> new ResourceAlreadyExistsException("could not create " + contact.toString()));
