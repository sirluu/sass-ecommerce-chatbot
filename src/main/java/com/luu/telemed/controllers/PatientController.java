...
public class PatientController {
  ...
  public ResponseEntity<Patient> getPatientById(@PathVariable("id") String id)
    ...
    Patient result = patientService.findPatientById(id).orElseThrow(() -> {
  ...
  public ResponseEntity<Patient> createPatient(
      @ApiParam(value = "Patient", required = true) @RequestBody Patient patient)
      throws ResourceAlreadyExistsException {
    Patient result = patientService.insertPatient(patient).orElseThrow(
        () -> new ResourceAlreadyExistsException("could not create " + patient.toString()));
  ...
  public ResponseEntity<Photo> getUpdatePhoto(@PathVariable("id") String id,
    ...
    patient.setAvatar(photoService.save(photo)
  ...
  public ResponseEntity<MessageResponse> changePassowrd(@PathVariable("id") String id,
    ...
    if (encoder.matches(password.getOldPassword(), patient.getPassword())) {
      ...
      patientService.save(patient).orElseThrow(
